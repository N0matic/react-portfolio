...
function ImageCard(props) {
  return (
    <div className="grid bg-local bg-center bg-no-repeat bg-cover box-content bg-blue-500 h-56 w-64 m-4 border-4 border-gray-400 shadow-xl hover:shadow-outline
    text-indigo-100">
      ...
      <div className="z-10 text-center font-serif">
        ...
        <div className="inline-flex bg-teal-400 p-1 my-1 border border-indigo-100">
