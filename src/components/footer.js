...
function Footer() {
  return (
    <div className="flex justify-center md:justify-around mt-5 md:mt-12 bottom-0">
      <a target="_blank" rel="noopener noreferrer" href="https://github.com/N0matic">
        <img src={github} alt="github icon" className="w-12 h-12 mr-4" />
      </a>
      <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/z-naddaf-b22971191/">
        <img src={linkedin} alt="linkedin icon" className="w-12 h-12 mr-4" />
      </a>
      <a target="_blank" rel="noopener noreferrer" href="mailto: znaddaf@gmail.com">
